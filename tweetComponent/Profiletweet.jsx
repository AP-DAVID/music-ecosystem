...
function Profiletweet({ session, data }) {
  ...
  return (
    <div>
      {/* This component is for the tweet box created after a user makes a music tweet */}
        ...
        <div className="p-3">
          <div className=" flex justify-between w-full items-center">
            <img
              ...
              alt="Profile picture"
              className="cursor-pointer h-20 w-20 rounded-full mt-5 object-cover"
            />
            <br />
            <div className="">
              <h1 className="border-2 hover:text-green-600 text-blue-600 w-full cursor-pointer rounded-l-full rounded-r-full  px-2 py-2 text-base text-center align-baseline">
                Edit profile
              </h1>
            </div>
          </div>
          ...
          <br />
          <span className="text-sm font-semibold ml-5 p-5">
          ...
          <span className="font-extralight text-gray-600 mt-1 text-xs flex items-center">
            ...
            <div>
              <h1 className="font-extralight text-gray-600 text-xs">
          ...
          <div className="flex items-center space-x-3">
            <div>
              <h1 className="text-extralight text-gray-600 text-xs">
        ...
        <div className="border-b-2 h-8 flex items-center w-full">
          <div className="w-1/2 text-center ">
            <h1
              ...
              className={`text-base font-semibold h-full ${
