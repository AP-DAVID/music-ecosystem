          ...
          <div className="relative w-2/3 my-auto mx-auto max-w-full">
            ...
            <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              {/*body*/}
                  ...
                  <img src={session?.user?.profilePicture} className="ml-2 mt-2  h-20 w-20 object-cover rounded-full cursor-pointer"/>
                  ...
                  <form className="h-full w-full ml-6 sm:px-5 my-10 sm:mr:10 justify-items-stretch sm:space-x-1 sm:grid md:grid:cols-2 lg:grid-cols-2 xl:grid-cols-3 3xl:flex flex-wrap justify-center">
                    <div >
                        ...
                        <input type="text" className="h-16 w-54 rounded-full bg-gray-200 shadow-md " value={session?.user?.username}/>
                    </div>

                    <div>
                        <h4 className="text-base text-gray-500">Contact</h4>

                        <input type="number" className="h-16 bg-gray-200 shadow-md  w-54 rounded-full " value={session?.user?.phonenumber}/>
                    </div>

                    <div>
                        <h4 className="text-base text-gray-500">Email</h4>

                        <input type="email" className="h-16 bg-gray-200 shadow-md  w-54 rounded-full " value={session?.user?.email}/>
                    </div>

                    <div>
                        <h4 className="text-base text-gray-500">Age</h4>

                        <input type="text" className="h-16 bg-gray-200 shadow-md  w-54 rounded-full " value={session?.user?.age}/>
                    </div>

                    <div>
                        <h4 className="text-base text-gray-500">State</h4>

                        <input type="text" className="h-16 bg-gray-200 shadow-md  w-54 rounded-full " />
                    </div>
