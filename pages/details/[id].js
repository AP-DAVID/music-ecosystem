...
const handleSubmit = async(e) =>{
  ...
  console.log(form);
    ...
    if(!reg){
      return (
        <div className="ui segment" style={{display: "flex", flexDirection : "column", justifyContent : "center", height : '100vh' }}>
            <main>
              <Oops />
            </main>
      </div>
                ...
                >
                  ...
                  <div className="flex mb-4 w-full justify-center text-center align-middle">
                      ...
                      <div className="flex flex-col space-y-4 align-middle text-center">
                        <Image className="object-contain rounded-full max-h-52" src={image ? image :  'https://react.semantic-ui.com/images/wireframe/square-image.png'} bordered size='small' />
                        
                        
                        <label
                          className="w-36 ml-3 flex flex-col items-center px-4 bg-gray-600 rounded-md shadow-md tracking-wide uppercase border border-blue cursor-pointer hover:bg-blue-600 hover:text-white text-black ease-linear transition-all duration-150">
